...
public class CodeManagerx : MonoBehaviour
{

    public static CodeManagerx instance;
    ...
    public abstract class Powerup
    {
        ...
        public Powerup(Point _location)
        {
            location = _location;
            GenerateValues();
        }
    ...
    public class Buff : Powerup
    {
        ...
        public Buff(Type _type, float _potency, Point _location) : base(_location)
        {
            type = _type;
            potency = _potency;
            switch (type)
    ...
    public static Buff AddRandomCode(Point location)
    {
        int typeIndex = PRNG.Range(0, 4);
        ...
        Buff newCode = new Buff(type, 10, location);
        instance.codes.Add(newCode);
